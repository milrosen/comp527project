...
\begin{document}
    ...
    \begin{lemma}[Variable Substitution]\label{lem:simply_typed_variable}
    ...
    \begin{definition}
        ...
        \end{equation*}
        If $\Gamma:V\parto\Phi_2$ is a context, we let $\Gamma[\sigma/p]\coloneqq\l\{(x:\tau[\sigma/p])\st\Gamma(x)=\tau\r\}$.
    \end{definition}
